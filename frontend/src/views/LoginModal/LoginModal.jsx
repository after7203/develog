            ...
            <div className="login_modal" ref={loginRef}>
                ...
                <div className="white_block">
                    <div className="exit_wrapper">
                        <svg className="exit_btn" onClick={toggleLoginModal} stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 24 24" tabIndex="1" height="1.5em" width="1.5em" xmlns="http://www.w3.org/2000/svg"><path d="M19 6.41L17.59 5 12 10.59 6.41 5 5 6.41 10.59 12 5 17.59 6.41 19 12 13.41 17.59 19 19 17.59 13.41 12z"></path></svg>
                    </div>
                    <h1>로그인</h1>
                    <form onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <div className="wrapper_autologin">
                            ...
                            <label htmlFor="autologin" className="labl-autologin">로그인 상태 유지</label>
                        </div>
