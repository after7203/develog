...
function Home() {
  ...
  useEffect(() => {
    if (isPeriodSelect) {
      setTimeout(() => window.addEventListener("click", onClick, { once: true }), 10)
    }
    // else {
    //   window.removeEventListener("click", onClick);
    // }
      ...
      <div className='home'>
        <div className='menu'>
          <div className='filter'>
            <div className='trend check' ref={trend} onClick={() => { set_select_option('trend') }}>
              <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 24 24" height="1.5em" width="1.5em" xmlns="http://www.w3.org/2000/svg"><path d="M16 6l2.29 2.29-4.88 4.88-4-4L2 16.59 3.41 18l6-6 4 4 6.3-6.29L22 12V6z"></path></svg>
              <div className='string'>트렌딩</div>
              <div className='underline' ref={underline} />
            </div>
            <div className='new' ref={recent} onClick={() => { set_select_option('recent') }}>
              <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 24 24" height="1.5em" width="1.5em" xmlns="http://www.w3.org/2000/svg"><path d="M11.99 2C6.47 2 2 6.48 2 12s4.47 10 9.99 10C17.52 22 22 17.52 22 12S17.52 2 11.99 2zM12 20c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8zm.5-13H11v6l5.25 3.15.75-1.23-4.5-2.67z"></path></svg>
              <div className='string'>최신</div>
            </div>
            <button className='period' onClick={() => { !isPeriodSelect && setIsPeriodSelect(true) }}>
              {select_period}
            ...
            <div className={isPeriodSelect ? 'period_select visible' : 'period_select'} ref={period_select}>
