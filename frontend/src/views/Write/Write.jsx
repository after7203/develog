                                    ...
                                    </div>
                                    {
                                        ...
                                        <>
                                            ...
                                            <div className="loaded_series">
                                                {input.series.map((series) => <div key={series}>{series}</div>)}
                                            </div>
                                        </>
                                    }
                                </div>
                            ...
                            <div className="series_form">
                                ...
                                <div className="series_list">
                                    {userSeries.map((userSeries) => (
                                        <div className={input.series.includes(userSeries.name) ? 'select' : ''} onClick={toggleSeriesSelect} key={userSeries.name}>{userSeries.name}</div>
                                    ))}
                                </div>
