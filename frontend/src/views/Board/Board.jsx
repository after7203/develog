...
const Board = () => {
    ...
    const onSubmitReply = () => {
        axios.post(`${process.env.REACT_APP_SERVER_URI}/api/reply/${writer}/${boardURL}`, { parentBoard: board._id, userId: user, mongooseId: mongooseId, contents: textarea.current.value }).then(() => {
